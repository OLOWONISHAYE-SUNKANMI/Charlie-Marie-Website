      ...
      <div className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-20">
        ...
        <Fade direction="down">
          <div className="w-full lg:w-auto flex justify-center">
            <img
              src="https://res.cloudinary.com/depeqzb6z/image/upload/v1755591415/undraw_studying_n5uj-removebg-preview_ox2t1z.png"
              alt="info"
              className="w-full max-w-sm lg:max-w-md lg:m-10 lg:w-auto"
        ...
        <Slide direction="down">
          <div className="w-full lg:w-[60%] text-center lg:text-left">
            <h1 className="font-extrabold font-poppins text-2xl lg:text-3xl text-[#620000] mb-6">
              Aims and Objectives
            </h1>
            <ul className="space-y-5 font-semibold font-poppins text-sm lg:text-base">
              <li>We aim to provide adequate care and supervision for our children from very tender ages.</li>
              <li>We aim to give our children sound knowledge and prepare them for advanced education in later years by paying them individual attention.</li>
              <li>We shall encourage the child's social development through interaction with other children.</li>
              <li>We shall ensure that all our children are well prepared for higher education with ease and confidence to achieve excellence and greatness.</li>
              <li>We are resolved to produce well educated, well behaved and honest boys and girls for the future.</li>
              <li>So help us God, Amen</li>
            </ul>
          </div>
        </Slide>
      </div>
